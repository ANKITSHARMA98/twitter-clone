...
function TweetBox() {
    ...
    const sendTweet = (e) => {
        ...
        db.collection("posts").add({
            ...
            username: "AnkitSh19669930",
            verified: true,
            text: tweetMessage,
            image: tweetImage,
            avatar: "https://pbs.twimg.com/profile_images/1292340457091956736/GKNSYi3r_400x400.jpg",
        });
        setTweetMessage("");
        setTweetImage("");
        ...
        <div className="tweetBox">
            <form>
                <div className="tweetBox__input">
                    <Avatar src="https://pbs.twimg.com/profile_images/1292340457091956736/GKNSYi3r_400x400.jpg" />
